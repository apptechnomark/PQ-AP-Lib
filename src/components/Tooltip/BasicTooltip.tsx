...
const BasicTooltip: React.FC<TooltipProps> = ({
  content,
  position,
  children,
  className,
  ...
  return (
    ...
    >
      <span
        className={`flex justify-center items-center tooltipText absolute bg-[#92EADC] w-max max-w-[500px] text-darkCharcoal whitespace-nowrap p-[10px] border border-primary rounded-md opacity-0 before:absolute before:w-3 before:h-3 before:bg-[#92EADC] before:border-t before:border-primary before:border-r ${position === "top" &&
